...
export default function Navbar() {
    return (
        <div className="back relative flex justify-between w-260  h-[63px] mx-30 rounded-br-[20px] rounded-bl-[20px] bg-white/10 backdrop-blur-md">
            ...
            <div className="flex gap-15 my-8 justify-center items-center  ">
                ...
                <Link href="#" className='text-[#8f8f8f] text-[20px] font-bold hover:text-[white]'>Skills</Link>
